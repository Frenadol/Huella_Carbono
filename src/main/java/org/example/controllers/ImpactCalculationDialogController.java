...
public class ImpactCalculationDialogController {
    ...
    public void calculateDailyImpact() {
        ...
        impactLabel.setText("Impacto Diario: " + impact.setScale(2, BigDecimal.ROUND_HALF_UP) + " KG of CO2");
    }
    ...
    public void calculateWeeklyImpact() {
        ...
        impactLabel.setText("Impacto Semanal: " + impact.setScale(2, BigDecimal.ROUND_HALF_UP) + " KG of CO2");
    }
    ...
    public void calculateMonthlyImpact() {
        ...
        impactLabel.setText("Impacto Mensual: " + impact.setScale(2, BigDecimal.ROUND_HALF_UP) + " KG of CO2");
    }
